...
if __name__ == '__main__':
  ...
  parser.add_argument(
    '--output_graph',
    type=str,
    default='/content/drive/MyDrive/NGANGIANGINTERNSHIP/Job15_ImageRecognitionUseMachineLearning3/tmp/output_graph.pb',
  ...
  parser.add_argument(
    '--output_labels',
    type=str,
    default='/content/drive/MyDrive/NGANGIANGINTERNSHIP/Job15_ImageRecognitionUseMachineLearning3/tmp/output_labels.txt',
