...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = r'Recognize_VisionAPI\ServiceAccountToken.JSON'

# Load model YOLO đã train
model = YOLO("./License-plate-detection.pt")

# Đọc ảnh
image_path = r"D:\Documents\Work\NganGiang\HAQUANGDUNG\Job74\Dataset\0049_04676_b.jpg"
