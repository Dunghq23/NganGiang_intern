...
# ==== CONSTANTS ====
CROPPED_DIR = r"./Test/Cropped"
CHAR_OUTPUT_DIR = r"./Test/output_chars"
MODEL_PATH = r"D:\Documents\Work\NganGiang\HAQUANGDUNG\Job75\Model\model_nhan_dang_bien_so_final_2.h5"
os.makedirs(CROPPED_DIR, exist_ok=True)
os.makedirs(CHAR_OUTPUT_DIR, exist_ok=True)

# ==== MODEL LOADING ====
yolo_model = YOLO(r"D:\Documents\Work\NganGiang\HAQUANGDUNG\Job75\Model\License-plate-detection.pt")
...
def process_single_image(image_path):
    ...
    for i, result in enumerate(results):
        for j, box in enumerate(result.boxes):
            ...
            # Deskew the license plate image
