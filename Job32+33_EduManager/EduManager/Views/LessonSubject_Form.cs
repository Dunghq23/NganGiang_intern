...
{
    public partial class LessonSubject_Form : Form
    {
        // Khai báo dữ liệu
        private string selectedSubjectSymbol = string.Empty;

        // Khởi tạo form
        public LessonSubject_Form()
        {
            InitializeComponent();
        ...
        private void LessonSubject_Form_Load(object sender, EventArgs e)
        {
            LoadData();
        ...
        private void btnAddLessonSubject_Click(object sender, EventArgs e)
        {
            ...
            var addForm = new LessonSubject_Add(this);
            addForm.ShowDialog();
        }
        ...
        private void HandleEdit(int rowIndex)
        {
            ...
            var editForm = new LessonSubject_Edit_Form(this, lessonSymbol, lessonName, lt, bt, th);
            editForm.ShowDialog();
        }
