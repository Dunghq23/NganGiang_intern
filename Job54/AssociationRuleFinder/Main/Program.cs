...
namespace Main
{
    internal class Program
    {
        ...
        {
            List<List<string>> frequentItemSets = null;
            Stopwatch stopwatch = new Stopwatch();
            stopwatch.Start();
            ...
            switch (choice)
            {
                ...
                case "2":
                    ...
                    frequentItemSets = new Apriori(transactions, supportThreshold).GetFrequentItemSet();
                    break;
            ...
            Helper.PrintFrequentItemsets(frequentItemSets, transactions, supportThreshold);

            // In kết quả các tập phổ biến và luật kết hợp
            var rules = Helper.GetAssociationRules(frequentItemSets, transactions, supportThreshold);
