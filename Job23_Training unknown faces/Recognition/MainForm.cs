...
namespace Recognition
{
    public partial class MainForm : Form
    {
        ...
        private void btnIdentificationReport_Click(object sender, EventArgs e)
        {
            this.Hide();

            WrongIdentificationForm WrongIdentificationForm = new WrongIdentificationForm();
            WrongIdentificationForm.ShowDialog();
