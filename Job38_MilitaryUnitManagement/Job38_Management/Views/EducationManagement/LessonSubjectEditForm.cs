...
{
    public partial class LessonSubjectEditForm : Form
    {
        private readonly LessonSubjectForm _lessonSubjectForm;
        ...
        public LessonSubjectEditForm(LessonSubjectForm lessonSubjectForm, string lesson, string lessonName, int lt, int bt, int th)
        {
            InitializeComponent();
        ...
        private void LessonSubjectEditForm_Load(object sender, EventArgs e)
        {
