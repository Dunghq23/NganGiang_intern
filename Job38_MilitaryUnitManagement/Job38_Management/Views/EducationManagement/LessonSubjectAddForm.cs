...
{
    public partial class LessonSubjectAddForm : Form
    {
        private readonly LessonSubjectForm _lessonSubjectForm;

        public LessonSubjectAddForm()
        {
            InitializeComponent();
        }

        public LessonSubjectAddForm(LessonSubjectForm lessonSubjectForm)
        {
            InitializeComponent();
        ...
        private void LessonSubjectAddForm_Load(object sender, EventArgs e)
        {
