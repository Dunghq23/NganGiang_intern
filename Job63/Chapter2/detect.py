...
# Bản quyền 2017 Google LLC
#
# Được cấp phép theo Giấy phép Apache, Phiên bản 2.0 ("Giấy phép");
# bạn không được sử dụng tệp này trừ khi tuân thủ theo Giấy phép.
...
# được phân phối theo Giấy phép được phân phối theo CƠ SỞ "NGUYÊN TRẠNG",
# KHÔNG CÓ BẤT KỲ BẢO HÀNH HOẶC ĐIỀU KIỆN NÀO, dù là rõ ràng hay ngụ ý.
# Xem Giấy phép để biết ngôn ngữ cụ thể chi phối các quyền và
# hạn chế theo Giấy phép.

"""Ứng dụng này trình bày cách thực hiện các thao tác cơ bản với
...
python detect.py faces /home/pi/Desktop/DungShare/Chapter2_GoogleVisionAPI/Faces/StartUp.jpg

Để biết thêm thông tin, hãy tài liệu tại
...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = r'/home/pi/Desktop/DungShare/Chapter2_GoogleVisionAPI/ServiceAccToken_ChuThang.JSON'
